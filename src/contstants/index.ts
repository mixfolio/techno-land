...
const block3 = [
  {
    ...
    list: [
      { id: "1", text: "Водозаборные узлы" },
      { id: "2", text: "Канализационно-очистные станции" },
      { id: "3", text: "Электроподстанции" },
      { id: "4", text: "Системы вентиляции крупных объектов" },
    ],
  },
  {
    id: "block3-2",
    title: "Где применяется наше решение:",
    list: [
      { id: "1", text: "Жилищно-коммунальное хозяйство" },
      {
        id: "2",
        text: "Управление объектами торгово-развлекательной недвижимости",
      },
      { id: "3", text: "Управление объектами офисной недвижимости" },
    ],
  },
];
...
const achievements = [
  {
    id: "achiv-1",
    title:
      "Улучшение качества и бесперебойности предоставления коммунальных услуг:",
    list: [
      {
        id: "01",
        title: "Своевременное и качественное предоставление ресурсов.",
      },
      {
        id: "02",
        title: "Соответствие предоставляемых услуг установленным стандартам.",
      },
      {
        id: "03",
        title:
          "Повышение уровня доверия потребителей.Своевременное и качественное предоставление ресурсов.",
      },
    ],
  },
  {
    id: "achiv-2",
    title:
      "Обеспечение бесперебойного снабжения и сокращение упущенной выгоды за счет скорости восстановления:",
    list: [
      {
        id: "01",
        title: "Постоянная доступность ресурсов.",
      },
      {
        id: "02",
        title: "Предотвращение аварийных ситуаций.",
      },
      {
        id: "03",
        title: "Обеспечение стабильного снабжения ресурсами.",
      },
      {
        id: "04",
        title: "Снижение потерь времени и ресурсов из-за аварий.",
      },
    ],
  },
  {
    id: "achiv-3",
    title: "Создание единого информационного пространства:",
    list: [
      {
        id: "01",
        title:
          "Предоставление актуальной информации всем заинтересованным лицам.",
      },
      {
        id: "02",
        title: "Улучшение взаимодействия между подразделениями и службами.",
      },
      {
        id: "03",
        title: "Сокращение времени и ресурсов на поиск информации.",
      },
    ],
  },
];
